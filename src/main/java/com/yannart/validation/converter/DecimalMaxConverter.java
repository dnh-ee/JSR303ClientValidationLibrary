...
/**
 * Converter for the annotation <code>DecimalMax</code> to the attribute "max".
 * 
 */
public class DecimalMaxConverter implements JSR349ConstraintConverter<DecimalMax> {
	 ...
	 * {@inheritDoc}
	 */
	public void fillConstrainedPropertyAttributes(final DecimalMax max,
			final Map<String, Object> attributes,
			final ConstrainedProperty validatedProperty) {

        validatedProperty.addAttribute("number", "true");
		validatedProperty.addAttribute("max", max.value());
	}
}